...
class Shifter:
    def __init__(self, fileName, numSplits = 8, color1 = "#000000", color2 = "#ffffff"):
    ...
    def createSplits(self):
        ...
        self.splits[0] = (67, 67, 67) # if you want a dark background
        # self.splits[1] = (127, 127, 127)
        # print(self.splits)
...
sh = Shifter(sys.argv[1], 12, "#c0b283", "#f4f4f4")
sh.run()
